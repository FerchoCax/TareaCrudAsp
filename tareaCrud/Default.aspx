<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="tareaCrud._Default" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Label ID="lbl_codigo" runat="server" CssClass="badge" Text="Carne"></asp:Label>
    ...
    <asp:TextBox ID="txt_fn" runat="server" CssClass="form-control" TextMode="Date"></asp:TextBox>
     <asp:Label ID="lbl_email" runat="server" CssClass="badge" Text="Email"></asp:Label>
    ...
    <asp:TextBox ID="txt_genero" runat="server" CssClass="form-control" placeholder="M - F" MaxLength="1" ></asp:TextBox>
    <asp:Label ID="lbl_sangre" runat="server" CssClass="badge" Text="Sangre"></asp:Label>
    ...
    <asp:GridView ID="grid_estudiantes" runat="server" AutoGenerateColumns="False" CssClass="table-condensed" DataKeyNames="id,id_sangre" OnRowDeleting="grid_estudiante_RowDeleting" OnSelectedIndexChanged="grid_estudiante_SelectedIndexChanged">
        <Columns>
            ...
            <asp:BoundField DataField="sangre" HeaderText="Tipo Sangre" />
        </Columns>
    </asp:GridView>
</asp:Content>
